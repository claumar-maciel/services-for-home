...
@section('content')
    <div class="w-100 mt-4">
        <form class="container__auth__form mt-4" action="{{route('provider.profile.update')}}" method="POST"> 
            @csrf
            @method('PUT')
            ...
            <div class="d-flex justify-content-end form-group my-3">
                <a class="btn btn-secondary ms-2" href="{{ route('provider.home') }}">cancelar</a>
