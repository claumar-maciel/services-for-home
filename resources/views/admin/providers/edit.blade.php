        ...
        <form class="container__auth__form mt-4" action="{{route('admin.providers.update', ['provider' => $provider->id])}}" method="POST"> 
            ...
            <div class="container__auth__form__fields">            
                <div class="mb-4">
                    ...
                    <div class="form-group my-3">
                        <input type="text" class="form-control" placeholder="cpf - ex: 999.999.999-99" name="cpf" value="{{$provider->cpf}}">
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="form-group my-3">
                        <input type="text" class="form-control" placeholder="celular - ex: (99)99999-9999" name="celular" value="{{$provider->contato->celular}}">
                    </div>
            
                    <div class="form-group my-3">
                        <input type="text" class="form-control" placeholder="telefone residencial  - ex: (99)9999-9999" name="telefone_residencial" value="{{$provider->contato->telefone_residencial}}">
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="form-group my-3">
                        <input type="text" class="form-control" placeholder="CEP - ex: 99999-999" name="cep" value="{{$provider->endereco->cep}}">
                    </div>
