...
@section('content')
    ...
    <div class="w-100 mt-4 d-flex justify-content-center">
        <a href="{{ route('client.faqs') }}" class="btn btn-primary mx-3 d-flex align-items-center">
        ...
        <a href="{{ route('client.posts') }}" class="btn btn-primary mx-3 d-flex align-items-center">
